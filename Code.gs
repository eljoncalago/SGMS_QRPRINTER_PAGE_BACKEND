...
/**
 * Initialize the QR Generator system
 * Run this once to set up the database
 */
function initializeSystem() {
  try {
    Logger.log('Starting QR Generator initialization...');
    ...
    Logger.log('QR Generator initialization completed successfully!');
